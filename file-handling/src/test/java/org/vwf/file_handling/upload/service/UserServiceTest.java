...
public class UserServiceTest {
    ...
    void getByUserId_returnsUser_whenExists() {
        ...
        GenericResponse<JSONObject> genericResponse = GenericResponse.success(ResponseMessage.USER_FETCH_SUCCESS.getMessage(), data);
...
//
//        JSONObject data = new JSONObject(Map.of("user", mockUser));
//        GenericResponse<JSONObject> genericResponse = GenericResponse.success(ResponseMessage.USER_SAVE_SUCCESS.getMessage(), data);
//        // based on when() conditions, tests are done using these Assertions class methods
//        assertEquals(genericResponse, userService.saveUser(userDetailsDTO));
//    }
...
//        GenericResponse<JSONObject> genericResponse = GenericResponse.success(ResponseMessage.USER_DELETE_SUCCESS.getMessage(), data);
//
...
//        assertEquals(genericResponse, userService.deleteUser(2L));
//    }
}
